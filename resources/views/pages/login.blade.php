        ...
        <div class="mx-auto max-w-md px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl bg-white p-8 shadow-lg ring-1 ring-gray-200/50">
                ...
                <form class="mt-6 space-y-4" action="#" method="post">
                    ...
                    <button type="submit" class="w-full rounded-xl bg-primary py-3 font-semibold text-white hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">Masuk</button>
                </form>
                <p class="mt-4 text-center text-sm text-gray-600">Belum punya akun? <a href="{{ route('register') }}" class="font-semibold text-primary hover:underline">Daftar</a></p>
            </div>
        </div>
    </section>
@endsection
